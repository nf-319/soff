...
import { fetchAmoCrmPipelines, fetchDepartmentList, setOpenLid, setSectionId } from '../../store/apps/leads'
import dynamic from 'next/dynamic'
import { useFormik } from 'formik'
import * as Yup from 'yup'

const DepartmentSendSmsForm = dynamic(() => import('../../views/apps/lids/departmentItem/DepartmentSendSmsForm'), {
  ssr: false
})

// Dynamic import for EditDepartmentItemForm
const EditDepartmentItemForm = dynamic(() => import('../../views/apps/lids/departmentItem/EditDepartmentItemForm'), {
  ssr: false
})
