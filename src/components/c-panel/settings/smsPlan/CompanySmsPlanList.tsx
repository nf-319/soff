...
import { handleOpenSMSModal } from '../../../../store/apps/c-panel'
  ...
  return (
    <Box sx={{ pb: 5 }}>
      <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
        ...
        <Button onClick={() => dispatch(handleOpenSMSModal(true))} variant='contained' color='primary'>
      ...
      >
        {isGettingSMSTariffs ? (
          ...
          smsTariffs.map(tariff => <SMSCard item={tariff} />)
        ) : (
