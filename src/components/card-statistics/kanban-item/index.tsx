...
// ** Types Imports
import { KanbarItemProps } from '../types'
...
import { addOpenedUser } from '../../../store/apps/user'
...
import AddToGroupForm from '../../../views/apps/lids/anonimUser/AddToGroupForm'
import MergeToDepartment from '../../../views/apps/lids/anonimUser/MergeForm'
import SendSmsAnonimUserForm from '../../../views/apps/lids/anonimUser/SendSmsAnonimUserForm'
import AddNoteAnonimUser from '../../../views/apps/lids/anonimUser/AddNoteAnonimUser'
import { fetchGroupCheckList } from '../../../store/apps/leads'
