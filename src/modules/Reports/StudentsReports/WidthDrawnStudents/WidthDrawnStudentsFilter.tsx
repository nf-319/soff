...
export function WidthDrawnStudentsFilter() {
  ...
  const statusOptions = [
    { label: 'Bitirgan', value: 'ended' },
    { label: 'Sertifikat olgan', value: 'backend-a' },
    { label: 'Bitirmasdan ketgan', value: 'design-group' }
  ]
  ...
  return (
    <Box display={'flex'} flexDirection={'column'} gap={5}>
      ...
      <Grid container spacing={2}>
        ...
        <Grid item xs={6} sm={6} md={6}>
          <FormControl fullWidth size='small'>
            <InputLabel id='teacher-label'>Holatlar</InputLabel>
            <Select
              labelId='teacher-label'
              value={statusValue}
              label='Holatlar'
