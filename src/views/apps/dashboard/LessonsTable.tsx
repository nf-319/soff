                    ...
                    {lesson.lessons.map(item => {
                      ...
                      return (
                        <Box
                          ...
                          key={item.id}
                          sx={{
                            width:interval =='15'? `${(timeSlots.length - 1) * 50}px`:`${(timeSlots.length - 1) * 25}px`,
                            height: '45px',
                            position: 'absolute',
                            padding: '5px',
                            left: `${left}px`
                        ...
                        >
                          <Box
                            sx={{
                              ...
                              borderRadius: '8px',
                              backgroundColor: item.color.split(',')[1]  ? item.color.split(',')[1] : 'white',
                              width: '100%',
                              height: '100%',
                              cursor: 'pointer',
                              padding: '2px 6px',
                          ...
                          >
                            <Typography
                              sx={{
                                color: item.color.split(',')[0]  ? item.color.split(',')[0] : 'black',
                                fontSize: '10px'
                              }}
                            >
