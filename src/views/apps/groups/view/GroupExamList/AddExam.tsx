      ...
      >
        <label style={{ display: 'flex', alignItems: 'center' }}>
          <Checkbox
            checked={reExam}
            onChange={async () => (
              !reExam && setParentItem(null), formik.resetForm(), setReExam(!reExam), await getExams2()
            )}
          />
        ...
        {reExam && (
          <FormControl fullWidth>
            ...
            >
              {exams2.map(exam => (
                <MenuItem value={exam.id}>{exam.title}</MenuItem>
              ))}
            </Select>
            <FormHelperText error>
              {!!formik.errors.parent && formik.touched.parent && formik.errors.parent}
            </FormHelperText>
          </FormControl>
        )}
        <FormControl>
        ...
        <FormControl>
          ...
          />
          <FormHelperText error>
            {!!formik.errors.min_score && formik.touched.min_score && formik.errors.min_score}
          </FormHelperText>
        </FormControl>
        ...
        <FormControl>
          ...
          />
          <FormHelperText error>
            {!!formik.errors.max_score && formik.touched.max_score && formik.errors.max_score}
          </FormHelperText>
        </FormControl>
