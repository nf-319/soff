...
export default function GroupDetailsMobile({
  groupData,
                    ...
                    {isGettingGroupDetails ? (
                      ...
                      <Box style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                        ...
                        <Typography variant='body1' style={{ fontWeight: 500 }}>
                          ...
                          <span
                            style={{
                              color: daysLeft <= 2 ? '#f44336' : 'inherit',
                              fontWeight: daysLeft <= 2 ? 600 : 500
                            }}
                          >
                            {formattedDate}
                          </span>
                    ...
                    {isGettingGroupDetails ? (
                      ...
                      <Box style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                        ...
                        <CustomChip
                          ...
                          size='small'
                          label={`${
                            groupData?.monthly_amount && addPeriodToThousands(+groupData?.monthly_amount)
                          } so'm`}
                          color='secondary'
                          sx={{
                            height: 24,
