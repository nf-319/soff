      ...
      >
        ...
        >
          <Box gap={5} sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <Box display='flex' alignItems='center' flexWrap='wrap' gap='10px' sx={{ flex: 1 }}>
              <Typography variant='h5'>{t("O'quvchilar to'lovi")}</Typography>

              {!isLoading && <Chip label={String(paymentsCount)} variant='outlined' color='primary' size='medium' />}
              ...
              <Chip
                ...
                color='success'
                label={`${formatCurrency(total_payments)} so'm`}
              />
              ...
              {total_bonus && (
                <Chip
                  ...
                  sx={{ fontSize: '14px', display: isMobile ? 'flex' : 'none', fontWeight: 'bold' }}
                  color='success'
                  label={`${formatCurrency(total_bonus)} so'm`}
                />
              )}
            </Box>
            ...
            {total_bonus && (
              <Chip
                ...
                sx={{ fontSize: '14px', display: isMobile ? 'none' : 'flex', fontWeight: 'bold' }}
                color='warning'
                label={`${formatCurrency(total_bonus)} so'm (Bonus)`}
              />
            )}
          </Box>
